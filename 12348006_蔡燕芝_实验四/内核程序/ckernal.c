...
void cmain(){
	...
	while(1){
		...
		else if(mystrcmp(tmp,"run",n,3) == 1)/*进入run分支*/
		{
			...
			myprintf("a is the showOuch.com whith will show OUCH! in the sceen if you type the keyboard.\r\n $");
			myprintf("b is the runShowMyInt.com which will use the server in the kernal with interruption\r\n $");
			myprintf("c is the stone.com which will move to stone in the sceen.\r\n $");
